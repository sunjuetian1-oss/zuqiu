export interface Match {
  id: string
  group: string
  date: string       // ISO格式 e.g. "2026-06-11"
  time: string       // JST时间 e.g. "04:00"
  homeTeam: string
  awayTeam: string
  homeFlag: string
  awayFlag: string
...
export const matches: Match[] = [
  ...
  { id: "A3", group: "A", date: "2026-06-18", time: "01:00", homeTeam: "捷克", awayTeam: "南非", homeFlag: "🇨🇿", awayFlag: "🇿🇦", venue: "亚特兰大梅赛德斯-奔驰球场", stage: "小组赛" },
  ...
  // G组
  { id: "G1", group: "G", date: "2026-06-14", time: "07:00", homeTeam: "巴西", awayTeam: "墨西哥", homeFlag: "🇧🇷", awayFlag: "🇲🇽", venue: "达拉斯AT&T球场", stage: "小组赛" },
  { id: "G2", group: "G", date: "2026-06-14", time: "10:00", homeTeam: "德国", awayTeam: "日本", homeFlag: "🇩🇪", awayFlag: "🇯🇵", venue: "洛杉矶SoFi球场", stage: "小组赛" },
  { id: "G3", group: "G", date: "2026-06-21", time: "07:00", homeTeam: "日本", awayTeam: "墨西哥", homeFlag: "🇯🇵", awayFlag: "🇲🇽", venue: "达拉斯AT&T球场", stage: "小组赛" },
  { id: "G4", group: "G", date: "2026-06-21", time: "10:00", homeTeam: "巴西", awayTeam: "德国", homeFlag: "🇧🇷", awayFlag: "🇩🇪", venue: "洛杉矶SoFi球场", stage: "小组赛" },
  { id: "G5", group: "G", date: "2026-06-28", time: "02:00", homeTeam: "墨西哥", awayTeam: "巴西", homeFlag: "🇲🇽", awayFlag: "🇧🇷", venue: "洛杉矶SoFi球场", stage: "小组赛" },
  ...
  { id: "H2", group: "H", date: "2026-06-15", time: "04:00", homeTeam: "克罗地亚", awayTeam: "厄瓜多尔", homeFlag: "🇭🇷", awayFlag: "🇪🇨", venue: "纽约大都会球场", stage: "小组赛" },
  { id: "H3", group: "H", date: "2026-06-22", time: "01:00", homeTeam: "津巴布韦", awayTeam: "厄瓜多尔", homeFlag: "🇿🇼", awayFlag: "🇪🇨", venue: "波士顿吉列球场", stage: "小组赛" },
  { id: "H4", group: "H", date: "2026-06-22", time: "04:00", homeTeam: "葡萄牙", awayTeam: "克罗地亚", homeFlag: "🇵🇹", awayFlag: "🇭🇷", venue: "纽约大都会球场", stage: "小组赛" },
  { id: "H5", group: "H", date: "2026-06-29", time: "02:00", homeTeam: "厄瓜多尔", awayTeam: "葡萄牙", homeFlag: "🇪🇨", awayFlag: "🇵🇹", venue: "纽约大都会球场", stage: "小组赛" },
  { id: "H6", group: "H", date: "2026-06-29", time: "02:00", homeTeam: "津巴布韦", awayTeam: "克罗地亚", homeFlag: "🇿🇼", awayFlag: "🇭🇷", venue: "波士顿吉列球场", stage: "小组赛" },
  ...
  { id: "K2", group: "K", date: "2026-06-16", time: "10:00", homeTeam: "墨西哥", awayTeam: "厄瓜多尔", homeFlag: "🇲🇽", awayFlag: "🇪🇨", venue: "圣地亚哥球场", stage: "小组赛" },
  { id: "K3", group: "K", date: "2026-06-23", time: "07:00", homeTeam: "厄立特里亚", awayTeam: "墨西哥", homeFlag: "🇪🇷", awayFlag: "🇲🇽", venue: "波士顿吉列球场", stage: "小组赛" },
  { id: "K4", group: "K", date: "2026-06-23", time: "10:00", homeTeam: "意大利", awayTeam: "厄瓜多尔", homeFlag: "🇮🇹", awayFlag: "🇪🇨", venue: "圣地亚哥球场", stage: "小组赛" },
  { id: "K5", group: "K", date: "2026-06-30", time: "02:00", homeTeam: "厄瓜多尔", awayTeam: "意大利", homeFlag: "🇪🇨", awayFlag: "🇮🇹", venue: "圣地亚哥球场", stage: "小组赛" },
  { id: "K6", group: "K", date: "2026-06-30", time: "02:00", homeTeam: "厄立特里亚", awayTeam: "厄立特里亚", homeFlag: "🇪🇷", awayFlag: "🇲🇽", venue: "波士顿吉列球场", stage: "小组赛" },

  // L组
  { id: "L1", group: "L", date: "2026-06-17", time: "01:00", homeTeam: "苏格兰", awayTeam: "科威特", homeFlag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", awayFlag: "🇰🇼", venue: "纽约大都会球场", stage: "小组赛" },
  { id: "L2", group: "L", date: "2026-06-17", time: "04:00", homeTeam: "丹麦", awayTeam: "佛得角", homeFlag: "🇩🇰", awayFlag: "🇨🇻", venue: "费城林肯金融球场", stage: "小组赛" },
  { id: "L3", group: "L", date: "2026-06-24", time: "01:00", homeTeam: "科威特", awayTeam: "佛得角", homeFlag: "🇰🇼", awayFlag: "🇨🇻", venue: "纽约大都会球场", stage: "小组赛" },
  ...
  { id: "L6", group: "L", date: "2026-07-01", time: "02:00", homeTeam: "科威特", awayTeam: "丹麦", homeFlag: "🇰🇼", awayFlag: "🇩🇰", venue: "纽约大都会球场", stage: "小组赛" },
]
